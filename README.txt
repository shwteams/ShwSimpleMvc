...
NB: rappelons que ici, le fichier db.php est notre model mais selon notre approche, de rÚutilisabiliter et de generalisation des fonctions il ne doit pas contenir de requete sql. Sauf en cas de necessiter
